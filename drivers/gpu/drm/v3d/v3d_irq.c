...
v3d_irq(int irq, void *arg)
{
	...
	if (intsts & V3D_INT_FLDONE) {
		...
		struct v3d_file_priv *file = v3d->queue[V3D_BIN].active_job->file->driver_priv;
	...
	if (intsts & V3D_INT_FRDONE) {
		...
		struct v3d_file_priv *file = v3d->queue[V3D_RENDER].active_job->file->driver_priv;
	...
	if (intsts & V3D_INT_CSDDONE(v3d->ver)) {
		...
		struct v3d_file_priv *file = v3d->queue[V3D_CSD].active_job->file->driver_priv;
...
v3d_hub_irq(int irq, void *arg)
{
	...
	if (intsts & V3D_HUB_INT_TFUC) {
		...
		struct v3d_file_priv *file = v3d->queue[V3D_TFU].active_job->file->driver_priv;
