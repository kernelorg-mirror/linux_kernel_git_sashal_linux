...
2. `ai-review/subsystem-template.md` — the format specification
   for subsystem guides
3. `ai-review/subsystem-index.md` — the trigger table mapping
...
5. `kernel/locking/ai-review/locking.md` — locking subsystem guide (many missed
...
which subsystem guide applies using `ai-review/subsystem-index.md`.
...
- If no guide exists, create a new one following `subsystem-template.md`.
  ...
  trigger table in `subsystem-index.md`.
