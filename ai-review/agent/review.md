...
PHASE-2-SUBSYSTEM: Read subsystem-index.md, scan every row
...
Using subsystem-index.md (already loaded in Phase 1), check EVERY row against the
...
Subsystem trigger scan:
  ...
  ... (every row in subsystem-index.md)
Guides to load: [list]
```
